...
const Signup = () => {
  ...
  const onClickSignup = () => {
    const addPhonenumber = "010".concat(
      "-",
      inputPhonenumber2,
      "-",
      inputPhonenumber3
    ...
    let gender;
    if (selectGender === "남자") gender = "M";
    else if (selectGender === "여자") gender = "W";
    else gender = "X";
        ...
        <Row>
          ...
          <Col lg={4}>
            ...
            <Row>
              ...
              <Col lg={3}>
                <Form.Control
                  className={styles.phonenumberinput3}
                  type="tel"
                  maxLength="4"
                  placeholder=""
                  onChange={handleInputPhonenumber2}
                />
              </Col>
              <Col lg={1}>
              ...
              <Col lg={3}>
                <Form.Control
                  className={styles.phonenumberinput5}
                  type="tel"
                  maxLength="4"
                  placeholder=""
                  onChange={handleInputPhonenumber3}
                />
              </Col>
              <Col lg={2}></Col>
            </Row>
            <Form.Select
              className={styles.findpasswordquestion}
              aria-label="Default select example"
